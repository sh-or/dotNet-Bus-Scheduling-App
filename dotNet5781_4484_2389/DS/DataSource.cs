    ...
    public static class DataSource
    {
        ...
        static DataSource() //c-tor of DS
        {
            AllBuses = new List<Bus>()
            {
                ...
                new Bus{LicenseNumber=34567890, LicensingDate =new DateTime(2018, 10, 6), Kilometerage=34500, KmFromLastRefuel=0, Fuel=(1200-0)/1200.0, KmFromLastCare=34500, DateOfLastCare=new DateTime(2018, 10, 6),  Status=(StatusEnum)2, Driver="Yakov", IsExist=true},
