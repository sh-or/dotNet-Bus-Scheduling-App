...
namespace DS
{
    public static class DataSource
    {
        ...
        static DataSource() //c-tor of DS
        {
            ...
            {
                #region
                new LineStation{LineCode=11, StationCode=6, StationNumberInLine=0},
                new LineStation{LineCode=12, StationCode=13, StationNumberInLine=0},
                new LineStation{LineCode=13, StationCode=6, StationNumberInLine=0},
                new LineStation{LineCode=14, StationCode=26, StationNumberInLine=0},
                new LineStation{LineCode=15, StationCode=27, StationNumberInLine=0},
                new LineStation{LineCode=16, StationCode=23, StationNumberInLine=0},
                new LineStation{LineCode=17, StationCode=28, StationNumberInLine=0},
                new LineStation{LineCode=18, StationCode=9, StationNumberInLine=0},
                new LineStation{LineCode=19, StationCode=18, StationNumberInLine=0},
                new LineStation{LineCode=20, StationCode=19, StationNumberInLine=0},
                new LineStation{LineCode=21, StationCode=4, StationNumberInLine=0},
                new LineStation{LineCode=22, StationCode=4, StationNumberInLine=0},
                new LineStation{LineCode=23, StationCode=37, StationNumberInLine=0},
                new LineStation{LineCode=24, StationCode=39, StationNumberInLine=0},
                new LineStation{LineCode=25, StationCode=9, StationNumberInLine=0},

                new LineStation{LineCode=11, StationCode=5, StationNumberInLine=1},
                new LineStation{LineCode=12, StationCode=6, StationNumberInLine=1},
                new LineStation{LineCode=13, StationCode=7, StationNumberInLine=1},
                new LineStation{LineCode=14, StationCode=8, StationNumberInLine=1},
                new LineStation{LineCode=15, StationCode=21, StationNumberInLine=1},
                new LineStation{LineCode=16, StationCode=1, StationNumberInLine=1},
                new LineStation{LineCode=17, StationCode=24, StationNumberInLine=1},
                new LineStation{LineCode=18, StationCode=28, StationNumberInLine=1},
                new LineStation{LineCode=19, StationCode=27, StationNumberInLine=1},
                new LineStation{LineCode=20, StationCode=5, StationNumberInLine=1},
                new LineStation{LineCode=21, StationCode=2, StationNumberInLine=1},
                new LineStation{LineCode=22, StationCode=5, StationNumberInLine=1},
                new LineStation{LineCode=23, StationCode=34, StationNumberInLine=1},
                new LineStation{LineCode=24, StationCode=23, StationNumberInLine=1},
                new LineStation{LineCode=25, StationCode=1, StationNumberInLine=1},
#endregion
                #region
